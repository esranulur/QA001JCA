...
public static void bolme(int a ,int b){
    if (b==0){
        System.out.println("payda 0 olamaz lutfen 0 girmeyyiniz");
    }else {
...
public  static void bolme2(int a,int b){
    ...
    try {
        ...
        System.out.println("Lutfen paydayi 0 yapmayiniz cunku bu deger matematikte tanimsizdir ");

        }
    System.out.println("catch parantezinden sonra calismaya  devam eder mi ");
