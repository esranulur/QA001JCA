...
//Öncü Sıfırlar: Posta kodları bazen öncü sıfırlarla başlar. Örneğin, "01000" gibi.
// Eğer bu değerleri int olarak saklarsanız, öncü sıfırlar kaybolur ve sadece "1000" olarak saklanır.
// String olarak saklamak bu öncü sıfırların korunmasını sağlar.
